...
summary(f.dor<-glm.nb(ages$dorm~.-total+offset(log(total)),data=X))
...
dor1<-predict(f.dor,X.pred.young,type='response');dor1
...
dor2<-predict(f.dor,X.pred.old,type='response')
old.dor<-dor2%*%wts;old.dor
