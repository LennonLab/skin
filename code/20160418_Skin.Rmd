...
# Perform SEM: parameter estimates, errors, and signficance
```{r}
# Active
...
# Finding: total cells decreae with age and shower length (l2 and l3); increase with ecze
...
## The strong residual correlations among all metaolic classes suggests we are missing
...
### E. Simple linear regression to look at effect of age on active cells
```{r}
# Proportion active
...
plot(ages$age, prop.act, log = "y", ylim = c(0.001, 0.5), xlim = c(-010, 90), 
     xlab = expression(paste("Age")), cex.lab = 1.5,
     ylab = NA,
     xaxt = "n", yaxt = "n",
     pch = 22, lwd = 1.5, bg = "grey", col = "black", cex = 2)
