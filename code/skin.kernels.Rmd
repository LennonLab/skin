...
kern.act.prop <- density(act.per, bw = 0.1) 
kern.dead.prop <- density(dorm.per, bw = 0.1)
kern.dorm.prop <- density(dead.per, bw = 0.1)
...
```{r}
# Set-up for printing 
png(filename="/Users/lennonj/GitHub/skin/figures/Fig-kernel.png",width = 1200, height = 900, res = 96*2)
...
plot(kern.act.prop, main = NA, xaxt = "n", yaxt = "n", cex.lab = 1.5, ylab = "",
     xlab = "", xlim = c(-0.1, 1.1), ylim = c(0, 4), type = "l", lwd = 3, col = "red")

points(kern.dead.prop, type = "l", lwd = 3, col = "darkgreen")
points(kern.dorm.prop, type = "l", lwd = 3, col = "blue")
...
legend("topright", c("active", "dormant", "dead"), bty = "n", y.intersp = 1, lty = c(1,1,1), 
       lwd = 2.5, seg.len = 2.75, col = c("red","blue","darkgreen"), cex = 1)
